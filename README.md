...
### 【促进】
与传统的管道商业不同，平台不控制价值的创造，而是设定一些价值可以被创造和交换的机制，并制定原则来管理交互过程。猎聘有设立校园猎聘专门给在校生提供就业选择，也有给在职人员或是社会人员提供就业选择，这样无论是对于需要校园在校生的公司或者是需要经验老道的人士参加工作的公司猎聘都能满足他们的招人需求。而对于消费者也就是寻求工作的人士也能为他们创立不同的就业门槛，根据自身需求去选择，这样便能大大促进平台的交互。当然猎聘也需要制定相关规则来约束这些交互避免可能发生的侵害用户的行为。
### 【匹配】
大数据下的职业匹配推送系统
# 3. 大数据理论
- 大数据时代的思维变革：更多、更好、更杂
...
### 2. 大数据时代的思维变革：更多、更好、更杂
#### 1. 更多【大数据】
猎聘拥有超过5000万用户和五十万家企业的的数据库，并且通过招聘交易中产生的数据反过来再次丰富了猎聘的数据库，加强平台上的职位匹配精准度
#### 2. 更杂【大数据】
猎聘收集的数据包含各种类型，除了简历、招聘信息外还有许多用户与网站交互产生的数据废气，达到了充分的样本多样性和混杂型。
#### 3.更好【大数据】
